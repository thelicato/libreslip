...
def main():
    ...
    source = destination / 'LibreSlip-task-09-print-gate-plan.zip'
    ...
    if args.include_apk:
        built = ROOT / 'build/app/outputs/flutter-apk/app-release.apk'
        apk = destination / 'LibreSlip-task-09-print-gate-plan-preview.apk'
    ...
    (destination / 'LibreSlip-task-09-print-gate-plan-SHA256SUMS.txt').write_text(''.join(checksums))
