...
def main():
    ...
    source = destination / 'LibreSlip-task-08-item-statistics.zip'
    ...
    if args.include_apk:
        built = ROOT / 'build/app/outputs/flutter-apk/app-release.apk'
        apk = destination / 'LibreSlip-task-08-item-statistics-preview.apk'
    ...
    (destination / 'LibreSlip-task-08-item-statistics-SHA256SUMS.txt').write_text(''.join(checksums))
