...
def main():
    ...
    source = destination / 'LibreSlip-task-10-mode-protocol.zip'
    ...
    if args.include_apk:
        built = ROOT / 'build/app/outputs/flutter-apk/app-release.apk'
        apk = destination / 'LibreSlip-task-10-mode-protocol-preview.apk'
    ...
    (destination / 'LibreSlip-task-10-mode-protocol-SHA256SUMS.txt').write_text(''.join(checksums))
