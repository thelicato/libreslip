...
Validated on 26 September 2026 for LibreSlip 1.4.0, Android application identifier `io.thelicato.libreslip`.
...
| Release APK | Passed with a temporary development validation certificate. Verified version 1.4.0, application identifier `io.thelicato.libreslip`, minimum API 34, target API 36 and APK Signature Scheme v2. Flutter and Gradle outputs matched byte for byte. |
