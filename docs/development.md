...
Images are written under `build/previews`. This optional capture is skipped during normal tests; it is a review aid rather than a pixel-perfect golden assertion. The task 10 review set adds the Italian phone Server foundation to the English phone/tablet Overview, scrolled Italian dashboard, disconnected Compose, ticket, Settings and portability screens.
